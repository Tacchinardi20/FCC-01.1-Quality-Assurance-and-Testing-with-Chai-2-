...
suite('Functional Tests', function () {
  ...
  // Mocha allows testing asynchronous operations.
  ...
  // NOTE: The test having #example in their description string,
    ...
    test('Test GET /hello with no name', function (done) {  // Don't forget the callback...
      chai
        ...
        .end(function (err, res) {  // res is the response object.
          ...
          // It should response 'Hello Guest'.
...
Browser.site = 'https://001-quality-assurance-and-testing-with-chai.glitch.me';
